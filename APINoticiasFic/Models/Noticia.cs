namespace APINoticiasFic.Models
{
    public class Noticia
    {
            ...
            public static IEnumerable<Noticia> ObtenerNoticias()
            {
                ...
                List<Noticia> listaNoticias = System.Text.Json.JsonSerializer.Deserialize<List<Noticia>>(jsonString).ToList();
            ...
            public static bool ActualizarNoticia(string id, Noticia value)
            {
                ...
                if (encontrado != null)
                {
                    ...
                    encontrado.CantidadCaracteres = value.Contenido.Length;
